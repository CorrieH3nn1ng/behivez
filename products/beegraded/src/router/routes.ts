...
const routes: RouteRecordRaw[] = [
  ...
  // Workspace routes (DashboardLayout, requiresAuth)
  {
    ...
    children: [
      ...
      { path: 'admin', name: 'admin-dashboard', component: () => import('pages/AdminDashboardPage.vue') },
      { path: 'mock', name: 'workspace-mock', component: () => import('pages/MockAssessmentPage.vue') },
      { path: 'mock/result/:attemptId', name: 'mock-result', component: () => import('pages/MockResultPage.vue'), props: true },
      ...
      { path: 'braille', name: 'braille', component: () => import('pages/BraillePage.vue') },
      { path: 'science/:subject/:grade', name: 'science-tutor', component: () => import('pages/ScienceTutorPage.vue'), props: true },
